...
module quad
	...
	implicit none
		...
		real(qp), parameter :: const_real_qp_neg=-2.5_qp
		real(qp), parameter :: const_real_qp_sum=const_real_qp + 2.0_qp

		integer, parameter :: qp_twice = 2 * qp
		integer, parameter :: qp_plus_dp = qp + dp
		...
		complex(qp), parameter  :: const_cmplx_qp_neg=(-2.0_qp,3.0_qp)
		complex(qp), parameter  :: const_cmplx_qp_sum=const_cmplx_qp + (2.0_qp,-1.0_qp)
